## Tutorial: Addon Config OSCam OpenELEC / LibreELEC

##### ALERTA: Para o addon funcionar tem de primeiro instalar o addon OSCam que se encontra nos Services


### Instalar addon Config OSCam

#### Exemplo : Repositorio LibreELEC: Tnds (Wetek_Play/arm) add ons

##### Entrar no Repositorio para instalar o addon
![TVH](http://tnds82.tk/tutorials/images/oscam1.JPG "TVH")

##### Clicar em program add-ons
![TVH](http://tnds82.tk/tutorials/images/oscam2.JPG "TVH")

##### Escolher Config OSCam -> Clicar Install
![TVH](http://tnds82.tk/tutorials/images/oscam3.JPG "TVH")

##### Voltar atrás e ir aos My Addons
![TVH](http://tnds82.tk/tutorials/images/oscam4.JPG "TVH")

##### Clicar no Program add-ons
![TVH](http://tnds82.tk/tutorials/images/oscam5.JPG "TVH")

##### Escolher Config OSCam LibreELEC e clicar para entrar
![TVH](http://tnds82.tk/tutorials/images/oscam6.JPG "TVH")
