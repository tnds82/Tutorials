...
##### Activar o mesmo caso desejem configurar. Caso tenham uma Wetek ou Outro Equipamento e utilizem no proprio equipamento o Addon Oscam deixar nesta configuração "Oscam inside the box" e apenas colocar o ip da Wetek ou do outro equipamento
